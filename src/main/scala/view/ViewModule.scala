...
object ViewModule:
  ...
  object CLIView extends GameView:
    ...
    override def renderStatus(infectedCity: Int, totalCity: Int, abilities: List[String]): Unit =
    ...
    override def renderActionMenu(options: List[String]): Int =
