...
class WorldMapTest:
  ...
  def getNumberoOfInfectedCity: Unit =
    ...
    assertEquals(1,worldMap.changeCity(worldMap.getCityByName("i").get.infectCity()).numberOfCityInfected())
  @Test
  ...
  def getAdjacentCities(): Unit =
    ...
    val newWorldMAp = worldMap.changeCity(worldMap.getCityByName("m").get.infectCity())
  ...
  def changeACityOfTheMap(): Unit =
      assertEquals(worldMap.getCityByName("i").get.infectCity(), worldMap.changeCity(worldMap.getCityByName("i").get.infectCity()).getCityByName("i").get)
      assertNotEquals(worldMap.getCityByName("i").get.infectCity(), worldMap.changeCity(worldMap.getCityByName("j").get.infectCity()).getCityByName("j").get)
